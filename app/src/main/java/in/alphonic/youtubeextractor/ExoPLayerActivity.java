...
//        player.prepare(videoSource);
    ...
    private void mergerMediaSource(String url1, String url2) {
        ...
        MediaSource audiosource = new ProgressiveMediaSource.Factory(dataSourceFactory).createMediaSource(Uri.parse(url2));
        MediaSource videoSource = new ProgressiveMediaSource.Factory(dataSourceFactory).createMediaSource(Uri.parse(url1));
